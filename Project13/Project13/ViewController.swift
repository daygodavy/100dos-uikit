...
//  Project13
//
//  Created by Davy Chuon on 4/13/23.
//
import CoreImage
import UIKit
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    // handles rendering, computationally expensive so create here and use throughout
    var context: CIContext!
    // stores whatever filter user has activated
...
//        print(action.title!)
        ...
        // FIXME: below will fail without applyProcessing() adjustments
        currentFilter.setValue(beginImage, forKey: kCIInputImageKey)
